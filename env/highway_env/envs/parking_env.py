    ...
    def compute_reward(
        ...
        Returns:
            ...
            goal. Note that the following should always hold true:
                ob, reward, done, info = model.step()
                assert reward == model.compute_reward(ob['achieved_goal'], ob['desired_goal'], info)
        """
...
class ParkingEnv(AbstractEnv, GoalEnv):
    ...
    # For parking model with GrayscaleObservation, the model need
